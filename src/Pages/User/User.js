...
const User = () => {
  ...
  const user = useSelector(state => state.getuser.products.find((getuser) => getuser._id === userId));
        ...
        <div className="userShow">
          ...
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">Lahore</span>
            </div>
          </div>
        </div>
